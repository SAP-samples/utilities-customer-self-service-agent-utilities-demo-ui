		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Utilities Customer Self-Service Agent",
									"targetURL": "#comsaputlaiuidssa-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsaputlaiuidssa-display": {
								"semanticObject": "comsaputlaiuidssa",
								"action": "display",
								"description": "Utilities Customer Self-Service Agent",
								"title": "Utilities Customer Self-Service Agent",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.utl.ai.ui.dssa",
									"url": sap.ui.require.toUrl("com/sap/utl/ai/ui/dssa")
								}
							}
						}
					}
